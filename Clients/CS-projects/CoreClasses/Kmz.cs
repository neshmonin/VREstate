...
namespace CoreClasses
{
    ...
    public class Kmz : IDisposable
    {
        ...
        {
            m_collada = extractUpdatableItem("files/untitled.dae");
        ...
        public static string GetSiteUrl(string fileName)
        {
            ...
            string fullWebAddress = string.Format(@"http://{0}:{1}/{2}{3}/{4}/{5}/{6}",
                                                  m_httpServerUrl,
                                                  m_httpServerPort,
                                                  webAlias,
                                                  SuperServer.SUPERSERVERDIR,
        ...
        public static string GetSiteCachedUrl(string fileName)
        {
            ...
            string fullWebAddress = string.Format(@"http://{0}:{1}/{2}{3}/{4}/{5}/{6}/{7}",
                                                  m_httpServerUrl,
                                                  m_httpServerPort,
                                                  webAlias,
                                                  SuperServer.SUPERSERVERDIR,
