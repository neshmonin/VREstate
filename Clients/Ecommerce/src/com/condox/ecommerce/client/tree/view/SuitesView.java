...
import com.condox.ecommerce.client.tree.presenter.SuitesPresenter.IDisplay;
...
public class SuitesView extends Composite implements IDisplay {
	...
	private native void setSelectEvent()/*-{
		...
		$wnd.onSelectSuite = function(id){
			instance.@com.condox.ecommerce.client.tree.view.SuitesView::onSelectSuite(I)(id);
		}
	}-*/;
